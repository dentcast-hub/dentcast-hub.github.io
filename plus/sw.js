...
const SHELL = [
  ...
  '/plus/pathways.html',
  '/plus/pathway.html',
  '/plus/collections.html',
  '/plus/collection.html',
  '/plus/highlights.html',
  '/plus/profile.html',
  '/plus/js/profile-page.js',
  '/plus/plus.css?v=1',
  '/plus/plus-pages.css?v=1',
  '/plus/plus-desktop.css?v=1',
  '/plus/plus.js?v=1',
  '/plus/js/config.js',
  '/plus/js/util.js',
  '/plus/js/api.js',
  ...
  '/plus/js/pathways.js',
  '/plus/js/pathways-page.js',
  '/plus/js/pathway-page.js',
  '/plus/js/collections.js',
  '/plus/js/collections-page.js',
  '/plus/js/highlights.js',
  '/plus/js/highlights-page.js',
  '/plus/js/collection-page.js',
  '/plus/js/profile.js',
  '/plus/js/overlay.js',
  '/plus/js/pwa.js',
  '/plus/js/push.js',
