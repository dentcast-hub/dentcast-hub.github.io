...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=48';
import { premiumCta } from './premium-cta.js?v=48';
import { api, currentUser, apiBase } from './api.js?v=48';
import { openLoginModal } from './login-modal.js?v=48';
import { FOLDER_EN } from './content-index.js?v=48';
import { markReturnTrail } from './return-trail.js?v=48';
import { PALETTE } from './config.js?v=48';
import {
