...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=13';
import { premiumCta } from './premium-cta.js?v=13';
import { api, currentUser, apiBase } from './api.js?v=13';
import { openLoginModal } from './login-modal.js?v=13';
import { FOLDER_EN } from './content-index.js?v=13';
import { PALETTE } from './config.js?v=13';
import {
