...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=31';
import { premiumCta } from './premium-cta.js?v=31';
import { api, currentUser, apiBase } from './api.js?v=31';
import { openLoginModal } from './login-modal.js?v=31';
import { FOLDER_EN } from './content-index.js?v=31';
import { PALETTE } from './config.js?v=31';
import {
