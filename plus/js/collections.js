...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=36';
import { premiumCta } from './premium-cta.js?v=36';
import { api, currentUser, apiBase } from './api.js?v=36';
import { openLoginModal } from './login-modal.js?v=36';
import { FOLDER_EN } from './content-index.js?v=36';
import { markReturnTrail } from './return-trail.js?v=36';
import { PALETTE } from './config.js?v=36';
import {
