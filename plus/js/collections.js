...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=2';
import { premiumCta } from './premium-cta.js?v=2';
import { api, currentUser, apiBase } from './api.js?v=2';
import { openLoginModal } from './login-modal.js?v=2';
import { FOLDER_EN } from './content-index.js?v=2';
import { PALETTE } from './config.js?v=2';
import {
