...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=74';
import { premiumCta } from './premium-cta.js?v=74';
import { api, currentUser, apiBase } from './api.js?v=74';
...
import { PALETTE } from './config.js?v=74';
import {
