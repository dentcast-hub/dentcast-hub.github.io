...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=12';
import { premiumCta } from './premium-cta.js?v=12';
import { api, currentUser, apiBase } from './api.js?v=12';
import { openLoginModal } from './login-modal.js?v=12';
import { FOLDER_EN } from './content-index.js?v=12';
import { PALETTE } from './config.js?v=12';
import {
