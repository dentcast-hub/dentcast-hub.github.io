...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=43';
import { premiumCta } from './premium-cta.js?v=43';
import { api, currentUser, apiBase } from './api.js?v=43';
import { openLoginModal } from './login-modal.js?v=43';
import { FOLDER_EN } from './content-index.js?v=43';
import { markReturnTrail } from './return-trail.js?v=43';
import { PALETTE } from './config.js?v=43';
import {
