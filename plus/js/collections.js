...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=37';
import { premiumCta } from './premium-cta.js?v=37';
import { api, currentUser, apiBase } from './api.js?v=37';
import { openLoginModal } from './login-modal.js?v=37';
import { FOLDER_EN } from './content-index.js?v=37';
import { markReturnTrail } from './return-trail.js?v=37';
import { PALETTE } from './config.js?v=37';
import {
