...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=55';
import { premiumCta } from './premium-cta.js?v=55';
import { api, currentUser, apiBase } from './api.js?v=55';
import { openLoginModal } from './login-modal.js?v=55';
import { FOLDER_EN } from './content-index.js?v=55';
import { markReturnTrail } from './return-trail.js?v=55';
import { PALETTE } from './config.js?v=55';
import {
