...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=45';
import { premiumCta } from './premium-cta.js?v=45';
import { api, currentUser, apiBase } from './api.js?v=45';
import { openLoginModal } from './login-modal.js?v=45';
import { FOLDER_EN } from './content-index.js?v=45';
import { markReturnTrail } from './return-trail.js?v=45';
import { PALETTE } from './config.js?v=45';
import {
