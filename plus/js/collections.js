...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=16';
import { premiumCta } from './premium-cta.js?v=16';
import { api, currentUser, apiBase } from './api.js?v=16';
import { openLoginModal } from './login-modal.js?v=16';
import { FOLDER_EN } from './content-index.js?v=16';
import { PALETTE } from './config.js?v=16';
import {
