...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=75';
import { premiumCta } from './premium-cta.js?v=75';
import { api, currentUser, apiBase } from './api.js?v=75';
...
import { PALETTE } from './config.js?v=75';
import {
