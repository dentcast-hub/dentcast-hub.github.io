...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=15';
import { premiumCta } from './premium-cta.js?v=15';
import { api, currentUser, apiBase } from './api.js?v=15';
import { openLoginModal } from './login-modal.js?v=15';
import { FOLDER_EN } from './content-index.js?v=15';
import { PALETTE } from './config.js?v=15';
import {
