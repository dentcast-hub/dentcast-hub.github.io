...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=76';
import { premiumCta } from './premium-cta.js?v=76';
import { api, currentUser, apiBase } from './api.js?v=76';
...
import { PALETTE } from './config.js?v=76';
import {
