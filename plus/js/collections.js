...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=4';
import { premiumCta } from './premium-cta.js?v=4';
import { api, currentUser, apiBase } from './api.js?v=4';
import { openLoginModal } from './login-modal.js?v=4';
import { FOLDER_EN } from './content-index.js?v=4';
import { PALETTE } from './config.js?v=4';
import {
