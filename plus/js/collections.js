...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=73';
import { premiumCta } from './premium-cta.js?v=73';
import { api, currentUser, apiBase } from './api.js?v=73';
...
import { PALETTE } from './config.js?v=73';
import {
