...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=53';
import { premiumCta } from './premium-cta.js?v=53';
import { api, currentUser, apiBase } from './api.js?v=53';
...
import { PALETTE } from './config.js?v=53';
import {
