...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=72';
import { premiumCta } from './premium-cta.js?v=72';
import { api, currentUser, apiBase } from './api.js?v=72';
...
import { PALETTE } from './config.js?v=72';
import {
