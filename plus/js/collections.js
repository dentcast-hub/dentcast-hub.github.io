...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=69';
import { premiumCta } from './premium-cta.js?v=69';
import { api, currentUser, apiBase } from './api.js?v=69';
import { openLoginModal } from './login-modal.js?v=69';
import { FOLDER_EN } from './content-index.js?v=69';
import { markReturnTrail } from './return-trail.js?v=69';
import { PALETTE } from './config.js?v=69';
import {
