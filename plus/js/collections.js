...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=9';
import { premiumCta } from './premium-cta.js?v=9';
import { api, currentUser, apiBase } from './api.js?v=9';
import { openLoginModal } from './login-modal.js?v=9';
import { FOLDER_EN } from './content-index.js?v=9';
import { PALETTE } from './config.js?v=9';
import {
