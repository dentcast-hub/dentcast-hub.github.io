...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=3';
import { premiumCta } from './premium-cta.js?v=3';
import { api, currentUser, apiBase } from './api.js?v=3';
import { openLoginModal } from './login-modal.js?v=3';
import { FOLDER_EN } from './content-index.js?v=3';
import { PALETTE } from './config.js?v=3';
import {
