...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=42';
import { premiumCta } from './premium-cta.js?v=42';
import { api, currentUser, apiBase } from './api.js?v=42';
import { openLoginModal } from './login-modal.js?v=42';
import { FOLDER_EN } from './content-index.js?v=42';
import { markReturnTrail } from './return-trail.js?v=42';
import { PALETTE } from './config.js?v=42';
import {
