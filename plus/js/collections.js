...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=38';
import { premiumCta } from './premium-cta.js?v=38';
import { api, currentUser, apiBase } from './api.js?v=38';
import { openLoginModal } from './login-modal.js?v=38';
import { FOLDER_EN } from './content-index.js?v=38';
import { markReturnTrail } from './return-trail.js?v=38';
import { PALETTE } from './config.js?v=38';
import {
