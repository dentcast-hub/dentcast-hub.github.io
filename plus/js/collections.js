...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=41';
import { premiumCta } from './premium-cta.js?v=41';
import { api, currentUser, apiBase } from './api.js?v=41';
import { openLoginModal } from './login-modal.js?v=41';
import { FOLDER_EN } from './content-index.js?v=41';
import { markReturnTrail } from './return-trail.js?v=41';
import { PALETTE } from './config.js?v=41';
import {
