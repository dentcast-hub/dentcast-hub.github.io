...
import { openSheet, closeSheet, gateCard } from './sheet.js?v=33';
import { premiumCta } from './premium-cta.js?v=33';
import { api, currentUser, apiBase } from './api.js?v=33';
import { openLoginModal } from './login-modal.js?v=33';
import { FOLDER_EN } from './content-index.js?v=33';
import { markReturnTrail } from './return-trail.js?v=33';
import { PALETTE } from './config.js?v=33';
import {
