...
// the same question.
import { el, faNum, debounce } from './util.js?v=154';
import { api, ApiError, currentUser, meStatus } from './api.js?v=154';
import { premiumCta, lapsedNote, guestPremiumExtras, unreachableGate } from './premium-cta.js?v=154';
import { openLoginModal } from './login-modal.js?v=154';
import { registerSW } from './pwa.js?v=154';
import { wirePageBack } from './page-back.js?v=154';
import { intentRow } from './pathways.js?v=154';
import { certificateTerms } from './certificate-terms.js?v=154';
import { openSheet } from './sheet.js?v=154';
