...
// the same question.
import { el, faNum, debounce } from './util.js?v=97';
import { api, ApiError, currentUser, meStatus } from './api.js?v=97';
import { premiumCta, lapsedNote, guestPremiumExtras, unreachableGate } from './premium-cta.js?v=97';
