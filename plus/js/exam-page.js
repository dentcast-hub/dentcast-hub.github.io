...
// the same question.
import { el, faNum, debounce } from './util.js?v=129';
import { api, ApiError, currentUser, meStatus } from './api.js?v=129';
import { premiumCta, lapsedNote, guestPremiumExtras, unreachableGate } from './premium-cta.js?v=129';
import { openLoginModal } from './login-modal.js?v=129';
import { registerSW } from './pwa.js?v=129';
import { wirePageBack } from './page-back.js?v=129';
import { intentRow } from './pathways.js?v=129';
import { certificateTerms } from './certificate-terms.js?v=129';
import { openSheet } from './sheet.js?v=129';
