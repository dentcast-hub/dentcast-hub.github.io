...
// the same question.
import { el, faNum, debounce } from './util.js?v=130';
import { api, ApiError, currentUser, meStatus } from './api.js?v=130';
import { premiumCta, lapsedNote, guestPremiumExtras, unreachableGate } from './premium-cta.js?v=130';
import { openLoginModal } from './login-modal.js?v=130';
import { registerSW } from './pwa.js?v=130';
import { wirePageBack } from './page-back.js?v=130';
import { intentRow } from './pathways.js?v=130';
import { certificateTerms } from './certificate-terms.js?v=130';
import { openSheet } from './sheet.js?v=130';
