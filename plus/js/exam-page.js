...
import { api, ApiError, currentUser, meStatus } from './api.js?v=142';
...
import { intentRow } from './pathways.js?v=142';
import { certificateTerms } from './certificate-terms.js?v=142';
import { openSheet } from './sheet.js?v=142';
