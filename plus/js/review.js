...
import { el, faNum, signalStreakActivity, renderNoteLines } from './util.js?v=12';
import { api } from './api.js?v=12';
import { getModel, contentInfo } from './content-index.js?v=12';
import { flashcard, sourceHref } from './archive.js?v=12';
import { LABELS } from './config.js?v=12';
