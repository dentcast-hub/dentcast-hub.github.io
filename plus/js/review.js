...
import { el, faNum, signalStreakActivity, renderNoteLines } from './util.js?v=42';
import { api } from './api.js?v=42';
import { getModel, contentInfo } from './content-index.js?v=42';
import { flashcard, sourceHref } from './archive.js?v=42';
import { LABELS } from './config.js?v=42';
