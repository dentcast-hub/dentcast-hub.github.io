...
import { el, faNum, signalStreakActivity, renderNoteLines } from './util.js?v=48';
import { api } from './api.js?v=48';
import { getModel, contentInfo } from './content-index.js?v=48';
import { flashcard, sourceHref } from './archive.js?v=48';
import { LABELS } from './config.js?v=48';
