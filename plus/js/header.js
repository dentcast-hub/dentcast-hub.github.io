...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=83';
import { currentUser, api } from './api.js?v=83';
import { isOrgHost, detectContentId } from './config.js?v=83';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=83';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=83';
import { renderDashboard } from './dashboard.js?v=83';
import { renderProfile } from './profile.js?v=83';
import { maybeShowWelcome } from './welcome.js?v=83';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=83';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=83';
import { healPushSubscription } from './push.js?v=83';
import { maybeShowPremiumPopup } from './premium-popup.js?v=83';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=83';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=83';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=83';
import { installLibraryGate } from './library-gate.js?v=83';
