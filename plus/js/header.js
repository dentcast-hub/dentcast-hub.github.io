...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=79';
import { currentUser, api } from './api.js?v=79';
import { isOrgHost, detectContentId } from './config.js?v=79';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=79';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=79';
import { renderDashboard } from './dashboard.js?v=79';
import { renderProfile } from './profile.js?v=79';
import { maybeShowWelcome } from './welcome.js?v=79';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=79';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=79';
import { healPushSubscription } from './push.js?v=79';
import { maybeShowPremiumPopup } from './premium-popup.js?v=79';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=79';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=79';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=79';
import { installLibraryGate } from './library-gate.js?v=79';
