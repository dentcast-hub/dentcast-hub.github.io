...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=53';
import { currentUser, api } from './api.js?v=53';
import { isOrgHost, detectContentId } from './config.js?v=53';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=53';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=53';
import { renderDashboard } from './dashboard.js?v=53';
import { renderProfile } from './profile.js?v=53';
import { maybeShowWelcome } from './welcome.js?v=53';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=53';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=53';
import { healPushSubscription } from './push.js?v=53';
import { maybeShowPremiumPopup } from './premium-popup.js?v=53';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=53';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=53';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=53';
import { installLibraryGate } from './library-gate.js?v=53';
