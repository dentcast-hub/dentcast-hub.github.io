...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=39';
import { currentUser, api } from './api.js?v=39';
import { isOrgHost, detectContentId } from './config.js?v=39';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=39';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=39';
import { renderDashboard } from './dashboard.js?v=39';
import { renderProfile } from './profile.js?v=39';
import { maybeShowWelcome } from './welcome.js?v=39';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=39';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=39';
import { healPushSubscription } from './push.js?v=39';
import { maybeShowPremiumPopup } from './premium-popup.js?v=39';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=39';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=39';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=39';
import { installLibraryGate } from './library-gate.js?v=39';
