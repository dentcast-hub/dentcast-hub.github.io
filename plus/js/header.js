...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=65';
import { currentUser, api } from './api.js?v=65';
import { isOrgHost, detectContentId } from './config.js?v=65';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=65';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=65';
import { renderDashboard } from './dashboard.js?v=65';
import { renderProfile } from './profile.js?v=65';
import { maybeShowWelcome } from './welcome.js?v=65';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=65';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=65';
import { healPushSubscription } from './push.js?v=65';
import { maybeShowPremiumPopup } from './premium-popup.js?v=65';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=65';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=65';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=65';
import { installLibraryGate } from './library-gate.js?v=65';
