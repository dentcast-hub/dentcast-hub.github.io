...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=12';
import { currentUser, api } from './api.js?v=12';
import { isOrgHost, detectContentId } from './config.js?v=12';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=12';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=12';
import { renderDashboard } from './dashboard.js?v=12';
import { renderProfile } from './profile.js?v=12';
import { maybeShowWelcome } from './welcome.js?v=12';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=12';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=12';
import { healPushSubscription } from './push.js?v=12';
import { maybeShowPremiumPopup } from './premium-popup.js?v=12';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=12';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=12';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=12';
import { installLibraryGate } from './library-gate.js?v=12';
