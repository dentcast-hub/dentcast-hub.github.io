...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=82';
import { currentUser, api } from './api.js?v=82';
import { isOrgHost, detectContentId } from './config.js?v=82';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=82';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=82';
import { renderDashboard } from './dashboard.js?v=82';
import { renderProfile } from './profile.js?v=82';
import { maybeShowWelcome } from './welcome.js?v=82';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=82';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=82';
import { healPushSubscription } from './push.js?v=82';
import { maybeShowPremiumPopup } from './premium-popup.js?v=82';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=82';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=82';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=82';
import { installLibraryGate } from './library-gate.js?v=82';
