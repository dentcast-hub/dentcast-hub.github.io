...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=74';
import { currentUser, api } from './api.js?v=74';
import { isOrgHost, detectContentId } from './config.js?v=74';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=74';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=74';
import { renderDashboard } from './dashboard.js?v=74';
import { renderProfile } from './profile.js?v=74';
import { maybeShowWelcome } from './welcome.js?v=74';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=74';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=74';
import { healPushSubscription } from './push.js?v=74';
import { maybeShowPremiumPopup } from './premium-popup.js?v=74';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=74';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=74';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=74';
import { installLibraryGate } from './library-gate.js?v=74';
