...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=45';
import { currentUser, api } from './api.js?v=45';
import { isOrgHost, detectContentId } from './config.js?v=45';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=45';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=45';
import { renderDashboard } from './dashboard.js?v=45';
import { renderProfile } from './profile.js?v=45';
import { maybeShowWelcome } from './welcome.js?v=45';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=45';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=45';
import { healPushSubscription } from './push.js?v=45';
import { maybeShowPremiumPopup } from './premium-popup.js?v=45';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=45';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=45';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=45';
import { installLibraryGate } from './library-gate.js?v=45';
