...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=84';
import { currentUser, api } from './api.js?v=84';
import { isOrgHost, detectContentId } from './config.js?v=84';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=84';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=84';
import { renderDashboard } from './dashboard.js?v=84';
import { renderProfile } from './profile.js?v=84';
import { maybeShowWelcome } from './welcome.js?v=84';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=84';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=84';
import { healPushSubscription } from './push.js?v=84';
import { maybeShowPremiumPopup } from './premium-popup.js?v=84';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=84';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=84';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=84';
import { installLibraryGate } from './library-gate.js?v=84';
