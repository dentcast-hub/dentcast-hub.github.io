...
import { el, faNum, streakIsActiveToday, STREAK_ACTIVITY_EVENT } from './util.js?v=42';
import { currentUser, api } from './api.js?v=42';
import { isOrgHost, detectContentId } from './config.js?v=42';
import { openLoginModal, openOrgNotice, openNameGate, nameIsChosen } from './login-modal.js?v=42';
import { openOverlay, closeOverlay, overlayOpen } from './overlay.js?v=42';
import { renderDashboard } from './dashboard.js?v=42';
import { renderProfile } from './profile.js?v=42';
import { maybeShowWelcome } from './welcome.js?v=42';
import { startTour, maybeOfferTour, tourMenuAvailable, initTourAutostart } from './tour.js?v=42';
import { maybeShowNotifPrompt } from './notif-prompt.js?v=42';
import { healPushSubscription } from './push.js?v=42';
import { maybeShowPremiumPopup } from './premium-popup.js?v=42';
import { renderNotices, NOTICES_SEEN_EVENT } from './notices.js?v=42';
import { maybeCelebrate, ACHIEVEMENTS_SEEN_EVENT } from './achievements.js?v=42';
import { subscriptionMenuLabel, pricingHref } from './premium-cta.js?v=42';
import { installLibraryGate } from './library-gate.js?v=42';
