...
import { api, currentUser, meStatus } from './api.js?v=78';
import { el, faNum } from './util.js?v=78';
import { openSheet, closeSheet, gateCard } from './sheet.js?v=78';
import { premiumCta, guestPremiumExtras } from './premium-cta.js?v=78';
