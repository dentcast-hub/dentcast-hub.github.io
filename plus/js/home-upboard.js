...
import { api, currentUser, meStatus } from './api.js?v=77';
import { el, faNum } from './util.js?v=77';
import { openSheet, closeSheet, gateCard } from './sheet.js?v=77';
import { premiumCta, guestPremiumExtras } from './premium-cta.js?v=77';
