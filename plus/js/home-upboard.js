...
import { api, currentUser, meStatus } from './api.js?v=79';
import { el, faNum } from './util.js?v=79';
import { openSheet, closeSheet, gateCard } from './sheet.js?v=79';
import { premiumCta, guestPremiumExtras } from './premium-cta.js?v=79';
