...
import { PREMIUM_FEATURES } from './config.js?v=139';
...
const PITCH = {
  ...
  'گواهی‌نامهٔ تکمیل مسیر': 'یک مسیر یادگیری را تا آخرین قدم بخوانید و آزمون پایانی‌اش را بدهید؛ گواهی به نام خودتان صادر می‌شود، با کد یکتا و صفحهٔ تأیید عمومی — همان چیزی که روی لینکدین یا رزومه می‌گذارید.',
};
