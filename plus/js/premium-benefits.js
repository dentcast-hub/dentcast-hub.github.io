...
import { PREMIUM_FEATURES } from './config.js?v=151';
...
const PITCH = {
  ...
  'هایلایت‌های صوتی': 'مثل هایلایت متن، برای پادکست: وسط شنیدن یک بار بزنید و آخرِ تکه دوباره؛ همان تکه با یادداشت‌تان در دفترچه می‌ماند و از همان‌جا پخش می‌شود.',
  'مسیرِ منظم تا گواهی‌نامه': 'مسیر را به ترتیب درست بخوانید، ببینید کدام قدم مانده، و در پایان آزمونش را بدهید؛ گواهی به نام خودتان صادر می‌شود، با کد یکتا و صفحهٔ تأیید عمومی — همان چیزی که روی لینکدین یا رزومه می‌گذارید.',
};
