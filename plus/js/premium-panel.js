...
import { el, faNum, streakIsActiveToday } from './util.js?v=160';
import { currentUser, meStatus, api } from './api.js?v=160';
import { pricingHref, premiumCta } from './premium-cta.js?v=160';
import { openSheet, gateCard } from './sheet.js?v=160';
import { openLoginModal } from './login-modal.js?v=160';
import { PREMIUM_GROUPS, PREMIUM_ENTRIES } from './premium-catalog.js?v=160';
import { bundleRail, installTapGate, fillBundlesLive, BUNDLES_HREF } from './home-bundles.js?v=160';
import { armDesTool } from './des-scorer.js?v=160';
import { loadShowcase, pathwayShowcase } from './pathway-showcase.js?v=160';
import { reportChip } from './home-features.js?v=160';
import { getModel, freshFolders } from './content-index.js?v=160';
...
function fillFromMe(me) {
  ...
  // Only a month this account HAS a report for (reportChip, shared with the
  // homepage section) — a subscriber who joined this month has no last month.
  reportChip().then((t) => { if (t) paint('report', t, { live: true }); });
}
