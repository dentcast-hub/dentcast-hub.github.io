...
import { el, icon, faNum } from './util.js?v=42';
import { api } from './api.js?v=42';
import { premiumCta, guestPremiumExtras, lapsedNote } from './premium-cta.js?v=42';
import { openLoginModal } from './login-modal.js?v=42';
import { loadEngine, catalog, rootsFor, optionsFor, nodeInfo, accentFor, bundles, pathwayById, sequenceNextId } from './wayfinder-engine.js?v=42';
