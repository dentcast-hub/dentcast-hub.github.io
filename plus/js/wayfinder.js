...
import { el, icon, faNum } from './util.js?v=81';
import { api } from './api.js?v=81';
import { premiumCta, guestPremiumExtras, lapsedNote } from './premium-cta.js?v=81';
import { openLoginModal } from './login-modal.js?v=81';
import { loadEngine, catalog, rootsFor, optionsFor, nodeInfo, accentFor, bundles, pathwayById, sequenceNextId } from './wayfinder-engine.js?v=81';
