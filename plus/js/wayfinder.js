...
import { el, icon, faNum } from './util.js?v=79';
import { api } from './api.js?v=79';
import { premiumCta, guestPremiumExtras, lapsedNote } from './premium-cta.js?v=79';
import { openLoginModal } from './login-modal.js?v=79';
import { loadEngine, catalog, rootsFor, optionsFor, nodeInfo, accentFor, bundles, pathwayById, sequenceNextId } from './wayfinder-engine.js?v=79';
