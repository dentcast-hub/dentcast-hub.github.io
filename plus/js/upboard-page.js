...
import { api } from '/plus/js/api.js?v=84';
import { el, faNum } from '/plus/js/util.js?v=84';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=84';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=84';
import { openLoginModal } from '/plus/js/login-modal.js?v=84';
import { markReturnTrail } from '/plus/js/return-trail.js?v=84';
