...
import { api } from '/plus/js/api.js?v=23';
import { el, faNum } from '/plus/js/util.js?v=23';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=23';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=23';
import { openLoginModal } from '/plus/js/login-modal.js?v=23';
