...
import { api } from '/plus/js/api.js?v=46';
import { el, faNum } from '/plus/js/util.js?v=46';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=46';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=46';
import { openLoginModal } from '/plus/js/login-modal.js?v=46';
import { markReturnTrail } from '/plus/js/return-trail.js?v=46';
