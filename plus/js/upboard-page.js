...
import { api } from '/plus/js/api.js?v=72';
import { el, faNum } from '/plus/js/util.js?v=72';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=72';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=72';
import { openLoginModal } from '/plus/js/login-modal.js?v=72';
import { markReturnTrail } from '/plus/js/return-trail.js?v=72';
