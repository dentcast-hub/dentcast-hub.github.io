...
import { api } from '/plus/js/api.js?v=18';
import { el, faNum } from '/plus/js/util.js?v=18';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=18';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=18';
import { openLoginModal } from '/plus/js/login-modal.js?v=18';
