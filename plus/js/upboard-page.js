...
import { api } from '/plus/js/api.js?v=76';
import { el, faNum } from '/plus/js/util.js?v=76';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=76';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=76';
import { openLoginModal } from '/plus/js/login-modal.js?v=76';
import { markReturnTrail } from '/plus/js/return-trail.js?v=76';
