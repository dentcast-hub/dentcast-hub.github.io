...
import { api } from '/plus/js/api.js?v=11';
import { el, faNum } from '/plus/js/util.js?v=11';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=11';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=11';
import { openLoginModal } from '/plus/js/login-modal.js?v=11';
