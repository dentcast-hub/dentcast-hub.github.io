...
import { api } from '/plus/js/api.js?v=38';
import { el, faNum } from '/plus/js/util.js?v=38';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=38';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=38';
import { openLoginModal } from '/plus/js/login-modal.js?v=38';
import { markReturnTrail } from '/plus/js/return-trail.js?v=38';
