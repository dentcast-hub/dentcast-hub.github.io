...
import { api } from '/plus/js/api.js?v=14';
import { el, faNum } from '/plus/js/util.js?v=14';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=14';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=14';
import { openLoginModal } from '/plus/js/login-modal.js?v=14';
