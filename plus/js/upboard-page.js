...
import { api } from '/plus/js/api.js?v=88';
import { el, faNum } from '/plus/js/util.js?v=88';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=88';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=88';
import { openLoginModal } from '/plus/js/login-modal.js?v=88';
import { markReturnTrail } from '/plus/js/return-trail.js?v=88';
