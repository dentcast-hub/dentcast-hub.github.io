...
import { api } from '/plus/js/api.js?v=65';
import { el, faNum } from '/plus/js/util.js?v=65';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=65';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=65';
import { openLoginModal } from '/plus/js/login-modal.js?v=65';
import { markReturnTrail } from '/plus/js/return-trail.js?v=65';
