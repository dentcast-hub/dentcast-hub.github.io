...
import { api, currentUser, meStatus } from '/plus/js/api.js?v=122';
import { el, faNum } from '/plus/js/util.js?v=122';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=122';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=122';
import { openLoginModal } from '/plus/js/login-modal.js?v=122';
import { markReturnTrail } from '/plus/js/return-trail.js?v=122';
...
function explainEngagement(pct, cap, id, scope) {
  ...
  const among = own
    ...
    : 'مطالبِ دنت‌کست';
  const from = audio
    ? 'شنیده‌شدن، گفت‌وگو و اشتراک‌گذاری'
    : 'گفت‌وگو، هایلایت، افزودن به کالکشن، اشتراک‌گذاری و خوانده‌شدن تا آخر';
