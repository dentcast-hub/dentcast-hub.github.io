...
import { api } from '/plus/js/api.js?v=75';
import { el, faNum } from '/plus/js/util.js?v=75';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=75';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=75';
import { openLoginModal } from '/plus/js/login-modal.js?v=75';
import { markReturnTrail } from '/plus/js/return-trail.js?v=75';
