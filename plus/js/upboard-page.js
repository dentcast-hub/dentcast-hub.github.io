...
import { api, currentUser, meStatus } from '/plus/js/api.js?v=123';
import { el, faNum } from '/plus/js/util.js?v=123';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=123';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=123';
import { openLoginModal } from '/plus/js/login-modal.js?v=123';
import { markReturnTrail } from '/plus/js/return-trail.js?v=123';
