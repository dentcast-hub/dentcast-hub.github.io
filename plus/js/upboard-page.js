...
import { api } from '/plus/js/api.js?v=33';
import { el, faNum } from '/plus/js/util.js?v=33';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=33';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=33';
import { openLoginModal } from '/plus/js/login-modal.js?v=33';
import { markReturnTrail } from '/plus/js/return-trail.js?v=33';
