...
import { api } from '/plus/js/api.js?v=7';
import { el, faNum } from '/plus/js/util.js?v=7';
import { openSheet, closeSheet, gateCard } from '/plus/js/sheet.js?v=7';
import { premiumCta, guestPremiumExtras } from '/plus/js/premium-cta.js?v=7';
import { openLoginModal } from '/plus/js/login-modal.js?v=7';
