...
import { el, faNum, tehranDay } from './util.js?v=97';
import { certificatesBody } from './certificates.js?v=97';
import { api, ApiError, currentUser } from './api.js?v=97';
import { remindersBlock } from './reminders.js?v=97';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=97';
import { baleEnabled, baleDeepLink } from './config.js?v=97';
import { leagueEntryButton } from './league.js?v=97';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=97';
import { subscriptionCta } from './premium-cta.js?v=97';
import { copyToClipboard, confirmStrip, toast } from './hl-view.js?v=97';
