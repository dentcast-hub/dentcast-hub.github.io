...
import { el, faNum, tehranDay } from './util.js?v=79';
import { certificatesBody } from './certificates.js?v=79';
import { api, ApiError, currentUser } from './api.js?v=79';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=79';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=79';
import { baleEnabled, baleDeepLink } from './config.js?v=79';
import { leagueEntryButton } from './league.js?v=79';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=79';
import { subscriptionCta } from './premium-cta.js?v=79';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=79';
