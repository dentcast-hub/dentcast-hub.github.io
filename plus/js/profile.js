...
import { el, faNum, tehranDay } from './util.js?v=40';
import { api, ApiError, currentUser } from './api.js?v=40';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=40';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=40';
import { baleEnabled, baleDeepLink } from './config.js?v=40';
import { leagueEntryButton } from './league.js?v=40';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=40';
import { subscriptionCta } from './premium-cta.js?v=40';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=40';
