...
import { el, faNum, tehranDay } from './util.js?v=42';
import { api, ApiError, currentUser } from './api.js?v=42';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=42';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=42';
import { baleEnabled, baleDeepLink } from './config.js?v=42';
import { leagueEntryButton } from './league.js?v=42';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=42';
import { subscriptionCta } from './premium-cta.js?v=42';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=42';
