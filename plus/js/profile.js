...
import { el, faNum, tehranDay } from './util.js?v=47';
import { api, ApiError, currentUser } from './api.js?v=47';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=47';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=47';
import { baleEnabled, baleDeepLink } from './config.js?v=47';
import { leagueEntryButton } from './league.js?v=47';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=47';
import { subscriptionCta } from './premium-cta.js?v=47';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=47';
