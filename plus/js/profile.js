...
import { el, faNum, tehranDay } from './util.js?v=5';
import { api, ApiError, currentUser } from './api.js?v=5';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=5';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=5';
import { baleEnabled, baleDeepLink } from './config.js?v=5';
import { leagueEntryButton } from './league.js?v=5';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=5';
import { subscriptionCta } from './premium-cta.js?v=5';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=5';
