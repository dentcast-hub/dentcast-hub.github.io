...
import { el, faNum, tehranDay } from './util.js?v=80';
import { certificatesBody } from './certificates.js?v=80';
import { api, ApiError, currentUser } from './api.js?v=80';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=80';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=80';
import { baleEnabled, baleDeepLink } from './config.js?v=80';
import { leagueEntryButton } from './league.js?v=80';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=80';
import { subscriptionCta } from './premium-cta.js?v=80';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=80';
