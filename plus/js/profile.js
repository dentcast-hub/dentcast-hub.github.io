...
import { el, faNum, tehranDay } from './util.js?v=39';
import { api, ApiError, currentUser } from './api.js?v=39';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=39';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=39';
import { baleEnabled, baleDeepLink } from './config.js?v=39';
import { leagueEntryButton } from './league.js?v=39';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=39';
import { subscriptionCta } from './premium-cta.js?v=39';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=39';
