...
import { el, faNum, tehranDay } from './util.js?v=52';
import { api, ApiError, currentUser } from './api.js?v=52';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=52';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=52';
import { baleEnabled, baleDeepLink } from './config.js?v=52';
import { leagueEntryButton } from './league.js?v=52';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=52';
import { subscriptionCta } from './premium-cta.js?v=52';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=52';
