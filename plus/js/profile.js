...
import { el, faNum, tehranDay } from './util.js?v=74';
import { certificatesBody } from './certificates.js?v=74';
import { api, ApiError, currentUser } from './api.js?v=74';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=74';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=74';
import { baleEnabled, baleDeepLink } from './config.js?v=74';
import { leagueEntryButton } from './league.js?v=74';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=74';
import { subscriptionCta } from './premium-cta.js?v=74';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=74';
