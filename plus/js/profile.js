...
import { el, faNum, tehranDay } from './util.js?v=50';
import { api, ApiError, currentUser } from './api.js?v=50';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=50';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=50';
import { baleEnabled, baleDeepLink } from './config.js?v=50';
import { leagueEntryButton } from './league.js?v=50';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=50';
import { subscriptionCta } from './premium-cta.js?v=50';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=50';
