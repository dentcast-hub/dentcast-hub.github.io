...
import { el, faNum, tehranDay } from './util.js?v=83';
import { certificatesBody } from './certificates.js?v=83';
import { api, ApiError, currentUser } from './api.js?v=83';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=83';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=83';
import { baleEnabled, baleDeepLink } from './config.js?v=83';
import { leagueEntryButton } from './league.js?v=83';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=83';
import { subscriptionCta } from './premium-cta.js?v=83';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=83';
