...
import { el, faNum, tehranDay } from './util.js?v=49';
import { api, ApiError, currentUser } from './api.js?v=49';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=49';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=49';
import { baleEnabled, baleDeepLink } from './config.js?v=49';
import { leagueEntryButton } from './league.js?v=49';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=49';
import { subscriptionCta } from './premium-cta.js?v=49';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=49';
