...
import { el, faNum, tehranDay } from './util.js?v=23';
import { api, ApiError, currentUser } from './api.js?v=23';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=23';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=23';
import { baleEnabled, baleDeepLink } from './config.js?v=23';
import { leagueEntryButton } from './league.js?v=23';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=23';
import { subscriptionCta } from './premium-cta.js?v=23';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=23';
