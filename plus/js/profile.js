...
import { el, faNum, tehranDay } from './util.js?v=87';
import { certificatesBody } from './certificates.js?v=87';
import { api, ApiError, currentUser } from './api.js?v=87';
import { ensurePushSubscription, removePushSubscription, pushSupported } from './push.js?v=87';
import { telegramLoginEnabled, telegramCallbackUrl, telegramBotUsername } from './config.js?v=87';
import { baleEnabled, baleDeepLink } from './config.js?v=87';
import { leagueEntryButton } from './league.js?v=87';
import { achievementsBody, discountBody, maybeCelebrate } from './achievements.js?v=87';
import { subscriptionCta } from './premium-cta.js?v=87';
import { copyToClipboard, confirmStrip } from './hl-view.js?v=87';
