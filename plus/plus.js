...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=122';
import { currentUser, api } from './js/api.js?v=122';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=122';
import { openCollectionPicker } from './js/collections.js?v=122';
import { el, faNum } from './js/util.js?v=122';
import { initHomeCard } from './js/home-card.js?v=122';
import { initHomeFeatures } from './js/home-features.js?v=122';
import { initPremiumPanel } from './js/premium-panel.js?v=122';
import { initHomeBundles } from './js/home-bundles.js?v=122';
import { initHomeUpboard } from './js/home-upboard.js?v=122';
import { initDesTool } from './js/des-scorer.js?v=122';
import { initHeader } from './js/header.js?v=122';
import { initTourAutostart } from './js/tour.js?v=122';
import { initReadingTracker } from './js/reading.js?v=122';
import { initListeningTracker } from './js/listening.js?v=122';
import { initShareScoring, buildShareButton } from './js/share.js?v=122';
import { initHeart, buildHeartChip } from './js/votes.js?v=122';
import { mountClipControl, landOnClip } from './js/clips.js?v=122';
import { mountArticleThreads } from './js/article-threads.js?v=122';
import { mountChallenge } from './js/challenge.js?v=122';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=122';
import { mountDes } from './js/des.js?v=122';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=122';
...
const loadWorkbench = () => import('./js/workbench.js?v=122').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=122'), import('./js/premium-cta.js?v=122')])
