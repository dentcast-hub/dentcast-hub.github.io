...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=129';
import { currentUser, api } from './js/api.js?v=129';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=129';
import { openCollectionPicker } from './js/collections.js?v=129';
import { el, faNum } from './js/util.js?v=129';
import { initHomeCard } from './js/home-card.js?v=129';
import { initHomeFeatures } from './js/home-features.js?v=129';
import { initPremiumPanel } from './js/premium-panel.js?v=129';
import { initHomeBundles } from './js/home-bundles.js?v=129';
import { initHomeUpboard } from './js/home-upboard.js?v=129';
import { initDesTool } from './js/des-scorer.js?v=129';
import { initHeader } from './js/header.js?v=129';
import { initTourAutostart } from './js/tour.js?v=129';
import { initReadingTracker } from './js/reading.js?v=129';
import { initListeningTracker } from './js/listening.js?v=129';
import { initShareScoring, buildShareButton } from './js/share.js?v=129';
import { initHeart, buildHeartChip } from './js/votes.js?v=129';
import { mountClipControl, landOnClip } from './js/clips.js?v=129';
import { mountArticleThreads } from './js/article-threads.js?v=129';
import { mountChallenge } from './js/challenge.js?v=129';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=129';
import { mountDes } from './js/des.js?v=129';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=129';
...
const loadWorkbench = () => import('./js/workbench.js?v=129').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=129'), import('./js/premium-cta.js?v=129')])
