...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=117';
import { currentUser, api } from './js/api.js?v=117';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=117';
import { openCollectionPicker } from './js/collections.js?v=117';
import { el, faNum } from './js/util.js?v=117';
import { initHomeCard } from './js/home-card.js?v=117';
import { initHomeFeatures } from './js/home-features.js?v=117';
import { initPremiumPanel } from './js/premium-panel.js?v=117';
import { initHomeBundles } from './js/home-bundles.js?v=117';
import { initHomeUpboard } from './js/home-upboard.js?v=117';
import { initDesTool } from './js/des-scorer.js?v=117';
import { initHeader } from './js/header.js?v=117';
import { initTourAutostart } from './js/tour.js?v=117';
import { initReadingTracker } from './js/reading.js?v=117';
import { initListeningTracker } from './js/listening.js?v=117';
import { initShareScoring, buildShareButton } from './js/share.js?v=117';
import { initHeart, buildHeartChip } from './js/votes.js?v=117';
import { mountClipControl, landOnClip } from './js/clips.js?v=117';
import { mountArticleThreads } from './js/article-threads.js?v=117';
import { mountChallenge } from './js/challenge.js?v=117';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=117';
import { mountDes } from './js/des.js?v=117';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=117';
...
const loadWorkbench = () => import('./js/workbench.js?v=117').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=117'), import('./js/premium-cta.js?v=117')])
