...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=113';
import { currentUser, api } from './js/api.js?v=113';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=113';
import { openCollectionPicker } from './js/collections.js?v=113';
import { el, faNum } from './js/util.js?v=113';
import { initHomeCard } from './js/home-card.js?v=113';
import { initHomeFeatures } from './js/home-features.js?v=113';
import { initPremiumPanel } from './js/premium-panel.js?v=113';
import { initHomeBundles } from './js/home-bundles.js?v=113';
import { initHomeUpboard } from './js/home-upboard.js?v=113';
import { initDesTool } from './js/des-scorer.js?v=113';
import { initHeader } from './js/header.js?v=113';
import { initTourAutostart } from './js/tour.js?v=113';
import { initReadingTracker } from './js/reading.js?v=113';
import { initListeningTracker } from './js/listening.js?v=113';
import { initShareScoring, buildShareButton } from './js/share.js?v=113';
import { initHeart, buildHeartChip } from './js/votes.js?v=113';
import { mountClipControl, landOnClip } from './js/clips.js?v=113';
import { mountArticleThreads } from './js/article-threads.js?v=113';
import { mountChallenge } from './js/challenge.js?v=113';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=113';
import { mountDes } from './js/des.js?v=113';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=113';
...
const loadWorkbench = () => import('./js/workbench.js?v=113').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=113'), import('./js/premium-cta.js?v=113')])
