...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=160';
import { currentUser, api } from './js/api.js?v=160';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=160';
import { openCollectionPicker } from './js/collections.js?v=160';
import { el, faNum } from './js/util.js?v=160';
import { initHomeCard } from './js/home-card.js?v=160';
import { initHomeFeatures } from './js/home-features.js?v=160';
import { initPremiumPanel } from './js/premium-panel.js?v=160';
import { initHomeBundles } from './js/home-bundles.js?v=160';
import { initHomeUpboard } from './js/home-upboard.js?v=160';
import { initDesTool } from './js/des-scorer.js?v=160';
import { initHeader } from './js/header.js?v=160';
import { initTourAutostart } from './js/tour.js?v=160';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=160';
import { initListeningTracker } from './js/listening.js?v=160';
import { initShareScoring, buildShareButton } from './js/share.js?v=160';
import { initHeart, buildHeartChip } from './js/votes.js?v=160';
import { mountClipControl, landOnClip } from './js/clips.js?v=160';
import { mountArticleThreads } from './js/article-threads.js?v=160';
import { mountChallenge } from './js/challenge.js?v=160';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=160';
import { mountDes } from './js/des.js?v=160';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=160';
import { initAudioHub } from './js/audio-hub.js?v=160';
import { getModel, freshFolders } from './js/content-index.js?v=160';
...
const loadWorkbench = () => import('./js/workbench.js?v=160').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=160'), import('./js/premium-cta.js?v=160')])
