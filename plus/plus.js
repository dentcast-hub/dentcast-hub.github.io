...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=123';
import { currentUser, api } from './js/api.js?v=123';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=123';
import { openCollectionPicker } from './js/collections.js?v=123';
import { el, faNum } from './js/util.js?v=123';
import { initHomeCard } from './js/home-card.js?v=123';
import { initHomeFeatures } from './js/home-features.js?v=123';
import { initPremiumPanel } from './js/premium-panel.js?v=123';
import { initHomeBundles } from './js/home-bundles.js?v=123';
import { initHomeUpboard } from './js/home-upboard.js?v=123';
import { initDesTool } from './js/des-scorer.js?v=123';
import { initHeader } from './js/header.js?v=123';
import { initTourAutostart } from './js/tour.js?v=123';
import { initReadingTracker } from './js/reading.js?v=123';
import { initListeningTracker } from './js/listening.js?v=123';
import { initShareScoring, buildShareButton } from './js/share.js?v=123';
import { initHeart, buildHeartChip } from './js/votes.js?v=123';
import { mountClipControl, landOnClip } from './js/clips.js?v=123';
import { mountArticleThreads } from './js/article-threads.js?v=123';
import { mountChallenge } from './js/challenge.js?v=123';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=123';
import { mountDes } from './js/des.js?v=123';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=123';
...
const loadWorkbench = () => import('./js/workbench.js?v=123').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=123'), import('./js/premium-cta.js?v=123')])
