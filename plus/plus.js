...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=120';
import { currentUser, api } from './js/api.js?v=120';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=120';
import { openCollectionPicker } from './js/collections.js?v=120';
import { el, faNum } from './js/util.js?v=120';
import { initHomeCard } from './js/home-card.js?v=120';
import { initHomeFeatures } from './js/home-features.js?v=120';
import { initPremiumPanel } from './js/premium-panel.js?v=120';
import { initHomeBundles } from './js/home-bundles.js?v=120';
import { initHomeUpboard } from './js/home-upboard.js?v=120';
import { initDesTool } from './js/des-scorer.js?v=120';
import { initHeader } from './js/header.js?v=120';
import { initTourAutostart } from './js/tour.js?v=120';
import { initReadingTracker } from './js/reading.js?v=120';
import { initListeningTracker } from './js/listening.js?v=120';
import { initShareScoring, buildShareButton } from './js/share.js?v=120';
import { initHeart, buildHeartChip } from './js/votes.js?v=120';
import { mountClipControl, landOnClip } from './js/clips.js?v=120';
import { mountArticleThreads } from './js/article-threads.js?v=120';
import { mountChallenge } from './js/challenge.js?v=120';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=120';
import { mountDes } from './js/des.js?v=120';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=120';
...
const loadWorkbench = () => import('./js/workbench.js?v=120').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=120'), import('./js/premium-cta.js?v=120')])
