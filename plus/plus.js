...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=125';
import { currentUser, api } from './js/api.js?v=125';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=125';
import { openCollectionPicker } from './js/collections.js?v=125';
import { el, faNum } from './js/util.js?v=125';
import { initHomeCard } from './js/home-card.js?v=125';
import { initHomeFeatures } from './js/home-features.js?v=125';
import { initPremiumPanel } from './js/premium-panel.js?v=125';
import { initHomeBundles } from './js/home-bundles.js?v=125';
import { initHomeUpboard } from './js/home-upboard.js?v=125';
import { initDesTool } from './js/des-scorer.js?v=125';
import { initHeader } from './js/header.js?v=125';
import { initTourAutostart } from './js/tour.js?v=125';
import { initReadingTracker } from './js/reading.js?v=125';
import { initListeningTracker } from './js/listening.js?v=125';
import { initShareScoring, buildShareButton } from './js/share.js?v=125';
import { initHeart, buildHeartChip } from './js/votes.js?v=125';
import { mountClipControl, landOnClip } from './js/clips.js?v=125';
import { mountArticleThreads } from './js/article-threads.js?v=125';
import { mountChallenge } from './js/challenge.js?v=125';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=125';
import { mountDes } from './js/des.js?v=125';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=125';
...
const loadWorkbench = () => import('./js/workbench.js?v=125').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=125'), import('./js/premium-cta.js?v=125')])
