...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=157';
import { currentUser, api } from './js/api.js?v=157';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=157';
import { openCollectionPicker } from './js/collections.js?v=157';
import { el, faNum } from './js/util.js?v=157';
import { initHomeCard } from './js/home-card.js?v=157';
import { initHomeFeatures } from './js/home-features.js?v=157';
import { initPremiumPanel } from './js/premium-panel.js?v=157';
import { initHomeBundles } from './js/home-bundles.js?v=157';
import { initHomeUpboard } from './js/home-upboard.js?v=157';
import { initDesTool } from './js/des-scorer.js?v=157';
import { initHeader } from './js/header.js?v=157';
import { initTourAutostart } from './js/tour.js?v=157';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=157';
import { initListeningTracker } from './js/listening.js?v=157';
import { initShareScoring, buildShareButton } from './js/share.js?v=157';
import { initHeart, buildHeartChip } from './js/votes.js?v=157';
import { mountClipControl, landOnClip } from './js/clips.js?v=157';
import { mountArticleThreads } from './js/article-threads.js?v=157';
import { mountChallenge } from './js/challenge.js?v=157';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=157';
import { mountDes } from './js/des.js?v=157';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=157';
import { initAudioHub } from './js/audio-hub.js?v=157';
import { getModel, freshFolders } from './js/content-index.js?v=157';
...
const loadWorkbench = () => import('./js/workbench.js?v=157').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=157'), import('./js/premium-cta.js?v=157')])
