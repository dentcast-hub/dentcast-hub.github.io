...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=150';
import { currentUser, api } from './js/api.js?v=150';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=150';
import { openCollectionPicker } from './js/collections.js?v=150';
import { el, faNum } from './js/util.js?v=150';
import { initHomeCard } from './js/home-card.js?v=150';
import { initHomeFeatures } from './js/home-features.js?v=150';
import { initPremiumPanel } from './js/premium-panel.js?v=150';
import { initHomeBundles } from './js/home-bundles.js?v=150';
import { initHomeUpboard } from './js/home-upboard.js?v=150';
import { initDesTool } from './js/des-scorer.js?v=150';
import { initHeader } from './js/header.js?v=150';
import { initTourAutostart } from './js/tour.js?v=150';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=150';
import { initListeningTracker } from './js/listening.js?v=150';
import { initShareScoring, buildShareButton } from './js/share.js?v=150';
import { initHeart, buildHeartChip } from './js/votes.js?v=150';
import { mountClipControl, landOnClip } from './js/clips.js?v=150';
import { mountArticleThreads } from './js/article-threads.js?v=150';
import { mountChallenge } from './js/challenge.js?v=150';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=150';
import { mountDes } from './js/des.js?v=150';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=150';
import { initAudioHub } from './js/audio-hub.js?v=150';
import { getModel, freshFolders } from './js/content-index.js?v=150';
...
const loadWorkbench = () => import('./js/workbench.js?v=150').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=150'), import('./js/premium-cta.js?v=150')])
