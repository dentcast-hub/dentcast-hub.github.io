...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=154';
import { currentUser, api } from './js/api.js?v=154';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=154';
import { openCollectionPicker } from './js/collections.js?v=154';
import { el, faNum } from './js/util.js?v=154';
import { initHomeCard } from './js/home-card.js?v=154';
import { initHomeFeatures } from './js/home-features.js?v=154';
import { initPremiumPanel } from './js/premium-panel.js?v=154';
import { initHomeBundles } from './js/home-bundles.js?v=154';
import { initHomeUpboard } from './js/home-upboard.js?v=154';
import { initDesTool } from './js/des-scorer.js?v=154';
import { initHeader } from './js/header.js?v=154';
import { initTourAutostart } from './js/tour.js?v=154';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=154';
import { initListeningTracker } from './js/listening.js?v=154';
import { initShareScoring, buildShareButton } from './js/share.js?v=154';
import { initHeart, buildHeartChip } from './js/votes.js?v=154';
import { mountClipControl, landOnClip } from './js/clips.js?v=154';
import { mountArticleThreads } from './js/article-threads.js?v=154';
import { mountChallenge } from './js/challenge.js?v=154';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=154';
import { mountDes } from './js/des.js?v=154';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=154';
import { initAudioHub } from './js/audio-hub.js?v=154';
import { getModel, freshFolders } from './js/content-index.js?v=154';
...
const loadWorkbench = () => import('./js/workbench.js?v=154').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=154'), import('./js/premium-cta.js?v=154')])
