...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=131';
import { currentUser, api } from './js/api.js?v=131';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=131';
import { openCollectionPicker } from './js/collections.js?v=131';
import { el, faNum } from './js/util.js?v=131';
import { initHomeCard } from './js/home-card.js?v=131';
import { initHomeFeatures } from './js/home-features.js?v=131';
import { initPremiumPanel } from './js/premium-panel.js?v=131';
import { initHomeBundles } from './js/home-bundles.js?v=131';
import { initHomeUpboard } from './js/home-upboard.js?v=131';
import { initDesTool } from './js/des-scorer.js?v=131';
import { initHeader } from './js/header.js?v=131';
import { initTourAutostart } from './js/tour.js?v=131';
import { initReadingTracker } from './js/reading.js?v=131';
import { initListeningTracker } from './js/listening.js?v=131';
import { initShareScoring, buildShareButton } from './js/share.js?v=131';
import { initHeart, buildHeartChip } from './js/votes.js?v=131';
import { mountClipControl, landOnClip } from './js/clips.js?v=131';
import { mountArticleThreads } from './js/article-threads.js?v=131';
import { mountChallenge } from './js/challenge.js?v=131';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=131';
import { mountDes } from './js/des.js?v=131';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=131';
...
const loadWorkbench = () => import('./js/workbench.js?v=131').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=131'), import('./js/premium-cta.js?v=131')])
