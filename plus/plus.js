...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=109';
import { currentUser, api } from './js/api.js?v=109';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=109';
import { openCollectionPicker } from './js/collections.js?v=109';
import { el, faNum } from './js/util.js?v=109';
import { initHomeCard } from './js/home-card.js?v=109';
import { initHomeFeatures } from './js/home-features.js?v=109';
import { initHomeBundles } from './js/home-bundles.js?v=109';
import { initHomeUpboard } from './js/home-upboard.js?v=109';
import { initDesTool } from './js/des-scorer.js?v=109';
import { initHeader } from './js/header.js?v=109';
import { initTourAutostart } from './js/tour.js?v=109';
import { initReadingTracker } from './js/reading.js?v=109';
import { initListeningTracker } from './js/listening.js?v=109';
import { initShareScoring, buildShareButton } from './js/share.js?v=109';
import { initHeart, buildHeartChip } from './js/votes.js?v=109';
import { mountClipControl, landOnClip } from './js/clips.js?v=109';
import { mountArticleThreads } from './js/article-threads.js?v=109';
import { mountChallenge } from './js/challenge.js?v=109';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=109';
import { mountDes } from './js/des.js?v=109';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=109';
...
const loadWorkbench = () => import('./js/workbench.js?v=109').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=109'), import('./js/premium-cta.js?v=109')])
