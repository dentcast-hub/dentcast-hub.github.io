...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=124';
import { currentUser, api } from './js/api.js?v=124';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=124';
import { openCollectionPicker } from './js/collections.js?v=124';
import { el, faNum } from './js/util.js?v=124';
import { initHomeCard } from './js/home-card.js?v=124';
import { initHomeFeatures } from './js/home-features.js?v=124';
import { initPremiumPanel } from './js/premium-panel.js?v=124';
import { initHomeBundles } from './js/home-bundles.js?v=124';
import { initHomeUpboard } from './js/home-upboard.js?v=124';
import { initDesTool } from './js/des-scorer.js?v=124';
import { initHeader } from './js/header.js?v=124';
import { initTourAutostart } from './js/tour.js?v=124';
import { initReadingTracker } from './js/reading.js?v=124';
import { initListeningTracker } from './js/listening.js?v=124';
import { initShareScoring, buildShareButton } from './js/share.js?v=124';
import { initHeart, buildHeartChip } from './js/votes.js?v=124';
import { mountClipControl, landOnClip } from './js/clips.js?v=124';
import { mountArticleThreads } from './js/article-threads.js?v=124';
import { mountChallenge } from './js/challenge.js?v=124';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=124';
import { mountDes } from './js/des.js?v=124';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=124';
...
const loadWorkbench = () => import('./js/workbench.js?v=124').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=124'), import('./js/premium-cta.js?v=124')])
