...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=148';
import { currentUser, api } from './js/api.js?v=148';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=148';
import { openCollectionPicker } from './js/collections.js?v=148';
import { el, faNum } from './js/util.js?v=148';
import { initHomeCard } from './js/home-card.js?v=148';
import { initHomeFeatures } from './js/home-features.js?v=148';
import { initPremiumPanel } from './js/premium-panel.js?v=148';
import { initHomeBundles } from './js/home-bundles.js?v=148';
import { initHomeUpboard } from './js/home-upboard.js?v=148';
import { initDesTool } from './js/des-scorer.js?v=148';
import { initHeader } from './js/header.js?v=148';
import { initTourAutostart } from './js/tour.js?v=148';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=148';
import { initListeningTracker } from './js/listening.js?v=148';
import { initShareScoring, buildShareButton } from './js/share.js?v=148';
import { initHeart, buildHeartChip } from './js/votes.js?v=148';
import { mountClipControl, landOnClip } from './js/clips.js?v=148';
import { mountArticleThreads } from './js/article-threads.js?v=148';
import { mountChallenge } from './js/challenge.js?v=148';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=148';
import { mountDes } from './js/des.js?v=148';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=148';
import { initAudioHub } from './js/audio-hub.js?v=148';
import { getModel, freshFolders } from './js/content-index.js?v=148';
...
const loadWorkbench = () => import('./js/workbench.js?v=148').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=148'), import('./js/premium-cta.js?v=148')])
