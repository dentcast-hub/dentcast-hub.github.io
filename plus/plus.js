...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=107';
import { currentUser, api } from './js/api.js?v=107';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=107';
import { openCollectionPicker } from './js/collections.js?v=107';
import { el, faNum } from './js/util.js?v=107';
import { initHomeCard } from './js/home-card.js?v=107';
import { initHomeFeatures } from './js/home-features.js?v=107';
import { initHomeBundles } from './js/home-bundles.js?v=107';
import { initHomeUpboard } from './js/home-upboard.js?v=107';
import { initDesTool } from './js/des-scorer.js?v=107';
import { initHeader } from './js/header.js?v=107';
import { initTourAutostart } from './js/tour.js?v=107';
import { initReadingTracker } from './js/reading.js?v=107';
import { initListeningTracker } from './js/listening.js?v=107';
import { initShareScoring, buildShareButton } from './js/share.js?v=107';
import { initHeart, buildHeartChip } from './js/votes.js?v=107';
import { mountClipControl, landOnClip } from './js/clips.js?v=107';
import { mountArticleThreads } from './js/article-threads.js?v=107';
import { mountChallenge } from './js/challenge.js?v=107';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=107';
import { mountDes } from './js/des.js?v=107';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=107';
...
const loadWorkbench = () => import('./js/workbench.js?v=107').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=107'), import('./js/premium-cta.js?v=107')])
