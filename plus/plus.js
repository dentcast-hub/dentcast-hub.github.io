...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=149';
import { currentUser, api } from './js/api.js?v=149';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=149';
import { openCollectionPicker } from './js/collections.js?v=149';
import { el, faNum } from './js/util.js?v=149';
import { initHomeCard } from './js/home-card.js?v=149';
import { initHomeFeatures } from './js/home-features.js?v=149';
import { initPremiumPanel } from './js/premium-panel.js?v=149';
import { initHomeBundles } from './js/home-bundles.js?v=149';
import { initHomeUpboard } from './js/home-upboard.js?v=149';
import { initDesTool } from './js/des-scorer.js?v=149';
import { initHeader } from './js/header.js?v=149';
import { initTourAutostart } from './js/tour.js?v=149';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=149';
import { initListeningTracker } from './js/listening.js?v=149';
import { initShareScoring, buildShareButton } from './js/share.js?v=149';
import { initHeart, buildHeartChip } from './js/votes.js?v=149';
import { mountClipControl, landOnClip } from './js/clips.js?v=149';
import { mountArticleThreads } from './js/article-threads.js?v=149';
import { mountChallenge } from './js/challenge.js?v=149';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=149';
import { mountDes } from './js/des.js?v=149';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=149';
import { initAudioHub } from './js/audio-hub.js?v=149';
import { getModel, freshFolders } from './js/content-index.js?v=149';
...
const loadWorkbench = () => import('./js/workbench.js?v=149').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=149'), import('./js/premium-cta.js?v=149')])
