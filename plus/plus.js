...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=115';
import { currentUser, api } from './js/api.js?v=115';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=115';
import { openCollectionPicker } from './js/collections.js?v=115';
import { el, faNum } from './js/util.js?v=115';
import { initHomeCard } from './js/home-card.js?v=115';
import { initHomeFeatures } from './js/home-features.js?v=115';
import { initPremiumPanel } from './js/premium-panel.js?v=115';
import { initHomeBundles } from './js/home-bundles.js?v=115';
import { initHomeUpboard } from './js/home-upboard.js?v=115';
import { initDesTool } from './js/des-scorer.js?v=115';
import { initHeader } from './js/header.js?v=115';
import { initTourAutostart } from './js/tour.js?v=115';
import { initReadingTracker } from './js/reading.js?v=115';
import { initListeningTracker } from './js/listening.js?v=115';
import { initShareScoring, buildShareButton } from './js/share.js?v=115';
import { initHeart, buildHeartChip } from './js/votes.js?v=115';
import { mountClipControl, landOnClip } from './js/clips.js?v=115';
import { mountArticleThreads } from './js/article-threads.js?v=115';
import { mountChallenge } from './js/challenge.js?v=115';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=115';
import { mountDes } from './js/des.js?v=115';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=115';
...
const loadWorkbench = () => import('./js/workbench.js?v=115').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=115'), import('./js/premium-cta.js?v=115')])
