...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=156';
import { currentUser, api } from './js/api.js?v=156';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=156';
import { openCollectionPicker } from './js/collections.js?v=156';
import { el, faNum } from './js/util.js?v=156';
import { initHomeCard } from './js/home-card.js?v=156';
import { initHomeFeatures } from './js/home-features.js?v=156';
import { initPremiumPanel } from './js/premium-panel.js?v=156';
import { initHomeBundles } from './js/home-bundles.js?v=156';
import { initHomeUpboard } from './js/home-upboard.js?v=156';
import { initDesTool } from './js/des-scorer.js?v=156';
import { initHeader } from './js/header.js?v=156';
import { initTourAutostart } from './js/tour.js?v=156';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=156';
import { initListeningTracker } from './js/listening.js?v=156';
import { initShareScoring, buildShareButton } from './js/share.js?v=156';
import { initHeart, buildHeartChip } from './js/votes.js?v=156';
import { mountClipControl, landOnClip } from './js/clips.js?v=156';
import { mountArticleThreads } from './js/article-threads.js?v=156';
import { mountChallenge } from './js/challenge.js?v=156';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=156';
import { mountDes } from './js/des.js?v=156';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=156';
import { initAudioHub } from './js/audio-hub.js?v=156';
import { getModel, freshFolders } from './js/content-index.js?v=156';
...
const loadWorkbench = () => import('./js/workbench.js?v=156').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=156'), import('./js/premium-cta.js?v=156')])
