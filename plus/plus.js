...
import { detectContentId, findProseRoot, findProseBox, findProseEnd, INVITE_LINE, SS_MODE, SS_RETURN_STUDY, isOrgHost, PROGRESS_EXCLUDE } from './js/config.js?v=153';
import { currentUser, api } from './js/api.js?v=153';
import { openLoginModal, openOrgNotice } from './js/login-modal.js?v=153';
import { openCollectionPicker } from './js/collections.js?v=153';
import { el, faNum } from './js/util.js?v=153';
import { initHomeCard } from './js/home-card.js?v=153';
import { initHomeFeatures } from './js/home-features.js?v=153';
import { initPremiumPanel } from './js/premium-panel.js?v=153';
import { initHomeBundles } from './js/home-bundles.js?v=153';
import { initHomeUpboard } from './js/home-upboard.js?v=153';
import { initDesTool } from './js/des-scorer.js?v=153';
import { initHeader } from './js/header.js?v=153';
import { initTourAutostart } from './js/tour.js?v=153';
import { initReadingTracker, flushPendingReads } from './js/reading.js?v=153';
import { initListeningTracker } from './js/listening.js?v=153';
import { initShareScoring, buildShareButton } from './js/share.js?v=153';
import { initHeart, buildHeartChip } from './js/votes.js?v=153';
import { mountClipControl, landOnClip } from './js/clips.js?v=153';
import { mountArticleThreads } from './js/article-threads.js?v=153';
import { mountChallenge } from './js/challenge.js?v=153';
import { mountGlossaryNotes } from './js/glossary-notes.js?v=153';
import { mountDes } from './js/des.js?v=153';
import { mountReturnTrail, markReturnTrail } from './js/return-trail.js?v=153';
import { initAudioHub } from './js/audio-hub.js?v=153';
import { getModel, freshFolders } from './js/content-index.js?v=153';
...
const loadWorkbench = () => import('./js/workbench.js?v=153').then((m) => m.Workbench);
...
function openSeenGate() {
  Promise.all([import('./js/sheet.js?v=153'), import('./js/premium-cta.js?v=153')])
