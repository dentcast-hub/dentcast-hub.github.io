 ...
 * (`webpush`) selects that one sender; several (`webpush,telegram`) fan out to
 * all of them via MultiNotificationSender, so a message reaches every channel the
 * user has connected. Order is irrelevant (each channel skips missing users).
 */
