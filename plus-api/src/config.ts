...
export const config = {
  ...
  // streak length, the same shape as the renewal template (530460). Set to 0
  // (the default until the template is approved) the SMS step is skipped
  // entirely and GET /admin/notify/health says so, with the count of readers
  // waiting on it. The parameter NAMES are part of the registered template
  ...
  streakReminder: {
    ...
    smsTemplateId: int('STREAK_REMINDER_SMS_TEMPLATE_ID', 0),
