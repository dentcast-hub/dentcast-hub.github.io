...
import { findProseRoot } from '/plus/js/config.js?v=127';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=127')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=127').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=127')
