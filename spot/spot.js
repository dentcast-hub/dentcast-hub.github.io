...
import { findProseRoot } from '/plus/js/config.js?v=91';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=91')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=91').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=91')
