...
import { findProseRoot } from '/plus/js/config.js?v=105';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=105')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=105').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=105')
