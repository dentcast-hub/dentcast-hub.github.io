...
import { findProseRoot } from '/plus/js/config.js?v=81';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=81')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=81').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=81')
