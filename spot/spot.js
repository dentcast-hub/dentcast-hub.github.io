...
import { findProseRoot } from '/plus/js/config.js?v=6';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=6')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=6').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=6')
