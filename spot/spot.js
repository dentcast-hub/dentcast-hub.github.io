...
import { findProseRoot } from '/plus/js/config.js?v=114';
...
function report(kind, slotName, creativeId) {
  ...
  import('/plus/js/api.js?v=114')
    ...
    .catch(() => {
      ...
      import('/plus/js/api.js?v=114').then((m) => m.forgetBase()).catch(() => {});
    });
}
...
function viewerProbe() {
  return import('/plus/js/api.js?v=114')
