...
'@media (prefers-reduced-motion: reduce){.dc-podcast-trigger.is-playing .dc-music-eq i{animation:none;}.dc-podcast-trigger.is-playing{animation:none;}.dc-player-overlay{transition:none;}}';
  ...
  (function () {
    ...
    var DAILY = [
      [300,  '☕ ۵ دقیقه مطالعه‌ی تخصصی امروز — شروع خوبیه!'],
      [900,  '🎧 ۱۵ دقیقه یادگیری امروز — به‌اندازه‌ی نصف یک اپیزود عمیق شدی'],
      [1800, '🏆 نیم ساعت یادگیری امروز — این دیگه عادتِ حرفه‌ای‌هاست'],
      [3600, '⭐ یک ساعت کامل یادگیری امروز با دنت‌کست — کم‌نظیری! فردا هم منتظرتیم']
    ];
...
'[data-theme="dark"] #dc-shake-iframe{background:#1a2940;}';
  ...
  function dcPodMount() {
    ...
    dcPodFrame.src = '/player.html?v=5';   // identical src → identical resume/auto-advance
