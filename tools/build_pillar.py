...
PILLARS = {
    "bonding": {
        ...
        "page_title":       "باندینگ | فهرست موضوعی | دنت‌کست",
    ...
    "ceramics": {
        ...
        "page_title":       "سرامیک | فهرست موضوعی | دنت‌کست",
    ...
    "fixed-pros": {
        ...
        "page_title":       "پروتز ثابت | فهرست موضوعی | دنت‌کست",
    ...
    "implantology": {
        ...
        "page_title":       "ایمپلنتولوژی | فهرست موضوعی | دنت‌کست",
    ...
    "occlusion": {
        ...
        "page_title":       "اکلوژن | فهرست موضوعی | دنت‌کست",
    ...
    "esthetic": {
        ...
        "page_title":       "زیبایی | فهرست موضوعی | دنت‌کست",
    ...
    "treatment-planning": {
        ...
        "page_title":       "طرح درمان | فهرست موضوعی | دنت‌کست",
        ...
        "intro_paragraphs": [
            ...
            'این صفحه نقشه‌ای موضوعی از همین انضباط است. مطالب در <strong>چهار لایه</strong> چیده شده‌اند — از تشخیصِ جامع، تا تصمیمِ حفظ یا کشیدن، تا جایگزینیِ دندانِ ازدست‌رفته، و سنجشِ شواهدی که هر کدام از این تصمیم‌ها روی آن بنا می‌شود. هر مورد به منبع کاملش در دنت‌کست لینک شده — اپیزود پادکست، نوت‌کست، گلاسری، یا یادداشت بالینی.',
        ],
        "subtopics": [
            ...
            {"slug": "evidence-appraisal",         "title_fa": "سنجشِ شواهد", "icon": "icon-microscope", "intro_fa": "پیش از آنکه نتیجه‌ی یک مقاله وارد تصمیم شود، باید سنجیده شود: مطالعه از چه نوعی است، نتیجه‌اش چقدر به حقیقت نزدیک است (<strong>validity</strong>) و چقدر به بیمارِ ما ربط دارد (<strong>relevance</strong>). این لایه ابزارِ همین سنجش را می‌دهد."},
        ],
    },
    "removable-pros": {
        ...
        "page_title":       "پروتز متحرک | فهرست موضوعی | دنت‌کست",
    ...
    "operative": {
        ...
        "page_title":       "دندانپزشکی ترمیمی | فهرست موضوعی | دنت‌کست",
    ...
    "digital": {
        ...
        "page_title":       "دندانپزشکی دیجیتال | فهرست موضوعی | دنت‌کست",
    ...
    "practice-infrastructure": {
        ...
        "page_title":       "ابزار و زیرساخت | فهرست موضوعی | دنت‌کست",
        ...
        "intro_paragraphs": [
            ...
            'این صفحه نقشه‌ی همان جهان است. مطالب در <strong>پنج لایه</strong> چیده شده‌اند — از مبانیِ مدل‌های زبانی و کار با آن‌ها، تا مرزی که کاربردِ بالینی پشتِ آن می‌ایستد، شناختِ خودِ ابزارها، و مالکیتِ سایتی که کارتان روی آن می‌ماند. هر مورد به منبعِ کاملش در دنت‌کست لینک شده.',
        ],
        "subtopics": [
            ...
            {"slug": "site-ownership",      "title_fa": "مالکیتِ پلتفرم و سایتِ خودت", "icon": "icon-key",     "intro_fa": "کارتان جایی نگهداری می‌شود که قانونش را کسِ دیگری می‌نویسد. این لایه تفاوتِ داشتنِ محتوا با داشتنِ <strong>آدرس، دسترسی و بایگانی</strong> را باز می‌کند — و اینکه چه چیزی تعیین می‌کند کارِ امروزتان سه سالِ دیگر هم پیدا شود."},
        ],
    },
}
