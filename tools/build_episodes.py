...
INLINE_CSS = (
    ...
    '\n'
    '/* پلیر داخلی — پس‌زمینه‌ی برند توپر، اندازه‌ی بزرگ، متن سفید، دکمه‌ی اکسنت پُر */\n'
    '.player-cell:has(#internalBtn){\n'
    '  background:var(--pr);\n'
    '  border:1px solid rgba(var(--ac-rgb),.55);\n'
    '  box-shadow:\n'
    '    0 10px 36px rgba(var(--pr-rgb),.26),\n'
    '    0 2px 6px rgba(var(--pr-rgb),.12);\n'
    '  padding:32px 28px;\n'
    '}\n'
    '@media (min-width:720px){\n'
    ...
    '    #fff 100%);\n'
    '  border:1px solid rgba(var(--ac-rgb),.10);\n'
    '  box-shadow:var(--card-sh);\n'
    '  padding:6px;\n'
    '}\n'
    ...
    '    var(--surface) 100%);\n'
    '  border:1px solid rgba(var(--ac-rgb),.12);\n'
    '  box-shadow:var(--card-sh);\n'
    '}\n'
    '\n'
    '.capsule-btn{\n'
