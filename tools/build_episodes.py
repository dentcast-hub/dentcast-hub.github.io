...
INLINE_CSS = (
    ...
    '\n'
    '/* پلیر داخلی — قاب ادیتوریال بزرگ، گرادیان نرم برندی (متن‌ها و دکمه به پیش‌فرض برمی‌گردند) */\n'
    '.player-cell:has(#internalBtn){\n'
    '  background:linear-gradient(to bottom left,\n'
    '    rgba(var(--pr-rgb),.12) 0%,\n'
    '    rgba(var(--pr-rgb),.04) 60%,\n'
    '    #fff 100%);\n'
    '  border:1px solid rgba(var(--ac-rgb),.22);\n'
    '  box-shadow:\n'
    '    0 6px 22px rgba(var(--pr-rgb),.10),\n'
    '    0 1px 4px rgba(var(--pr-rgb),.06);\n'
    '  padding:24px 22px;\n'
    '}\n'
    '@media (min-width:720px){\n'
    '  .player-cell:has(#internalBtn){ padding:30px 30px; }\n'
    '}\n'
